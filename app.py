...
<script>
    ...
    function prepararFormularioParaEnvio() {
        // 1. Quitar todos los REQUIRED globalmente antes del envío
    ...
    function activarTollgate(tgId, tgIdx) {
        ...
        // Aplicamos la lógica de requerimientos para destrabar el boton de avanzar
...
def home():
    ...
    if request.method == 'POST':
        ...
        if action_type == 'ver_lectura':
            ...
            # LÓGICA DE MENSAJE Y AVANCE ENTRE TOLLGATES
