  ...
  "TG2": {
    ...
    "secciones": [{
      ...
      "campos": [
        ...
        {"id": "contactos_adic", "campo": "Contactos Adicionales Identificados", "tipo": "UI_Contactos", "req": False, "ayuda": "Nombre, cargo y email de contactos adicionales.", "notas": ""}
      ]
    }]
  },
  "TG3": {
                                ...
                                <div class="sf-card-section">
                                    ...
                                    <div class="sf-field-grid">
                                        {% for field in seccion['campos'] %}
                                            ...
                                            <div class="sf-field-group" {% if field['tipo'] in ['Texto largo', 'UI_Contactos'] %}style="grid-column: span 2;"{% endif %}>
                                                <div class="sf-label">
                                                ...
                                                <!-- DESCRIPCIÓN GENÉRICA / COLUMNA F -->
...
<!-- MODAL CONTACTOS ADICIONALES (TG3/TG2) -->
<div id="modal-contacto" class="modal-overlay">
    <div class="modal-content">
        ...
        <div style="font-size:12px; color:var(--sf-text-muted); margin-bottom:16px;">Registre la información de un nuevo contacto o seleccione uno de su CRM.</div>
        ...
        <div class="sf-field-grid" style="padding:0; grid-template-columns: 1fr 1fr;">
            ...
            <div class="sf-field-group">
                ...
                <input type="text" id="mod_empresa" class="sf-input" value="{{ d_curr.get('empresa', '') }}">
            </div>
            <div class="sf-field-group">
...
<script>
    ...
    // --- LÓGICA DE FICHAS DE CONTACTOS ADICIONALES ---
    let arrayContactos = [];
    ...
    function inicializarContactos() {
        ...
        // Simulación CRM: Si la empresa ya está escrita en el formulario principal y el arreglo está vacío, 
        // inyectamos una ficha sugerida del CRM simulando que ya existe un contacto.
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Formateo visual al cargar para monedas
        ...
        // Inicializar sección de Fichas de Contacto
